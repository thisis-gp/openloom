export const dict = {
  ...
  "dialog.provider.openloom.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.openloom.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.openloomGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Openloom",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Openloom-u.",
  ...
  "provider.connect.openloomZen.line1":
    "Openloom Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.openloomZen.visit.prefix": "Posjeti ",
  "provider.connect.openloomZen.visit.link": "openloom.ai/zen",
  "provider.connect.openloomZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Openloom-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Openloom-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u openloom.json",
  ...
  "dialog.server.description": "Promijeni na koji se Openloom server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Openloom-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Openloom timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (openloom.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Openloom još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Openloom uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Openloom server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Openloom-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Openloom izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Openloom prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Openloom-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Openloom pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Openloom-a.",
