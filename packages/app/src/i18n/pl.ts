export const dict = {
  ...
  "dialog.provider.openloom.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.openloom.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.openloomGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Openloom",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Openloom.",
  ...
  "provider.connect.openloomZen.line1":
    "Openloom Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.openloomZen.visit.prefix": "Odwiedź ",
  "provider.connect.openloomZen.visit.link": "openloom.ai/zen",
  "provider.connect.openloomZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Openloom.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Openloom.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w openloom.json",
  ...
  "dialog.server.description": "Przełącz serwer Openloom, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Openloom ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Openloom",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (openloom.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Openloom zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Openloom",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Openloom na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Openloom ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Openloom.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Openloom",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Openloom.",
