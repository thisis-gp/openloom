...
export const dict = {
  ...
  "dialog.provider.openloom.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.openloom.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.openloomGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Openloom",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Openloom.",
  ...
  "provider.connect.openloomZen.line1":
    "Openloom Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.openloomZen.visit.prefix": "Besøk ",
  "provider.connect.openloomZen.visit.link": "openloom.ai/zen",
  "provider.connect.openloomZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Openloom.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Openloom.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i openloom.json",
  ...
  "dialog.server.description": "Bytt hvilken Openloom-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Openloom ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Openloom-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (openloom.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Openloom ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Openloom inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Openloom-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Openloom",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Openloom ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Openloom skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Openloom er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Openloom starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Openloom.",
