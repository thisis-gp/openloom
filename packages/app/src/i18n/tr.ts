...
export const dict = {
  ...
  "dialog.provider.openloom.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.openloom.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.openloomGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Openloom tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Openloom'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.openloomZen.line1":
    "Openloom Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.openloomZen.visit.prefix": "",
  "provider.connect.openloomZen.visit.link": "openloom.ai/zen",
  "provider.connect.openloomZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Openloom'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Openloom'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler openloom.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Openloom sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Openloom'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Openloom ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (openloom.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Openloom henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Openloom ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Openloom Masaüstü",
  ...
  "settings.desktop.wsl.description": "Openloom sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Openloom'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Openloom'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Openloom'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Openloom'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Openloom başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Openloom'un en son sürümünü kullanıyorsunuz.",
