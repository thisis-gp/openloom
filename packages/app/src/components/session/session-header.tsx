import { AppIcon } from "@openloom/ui/app-icon"
...
import { Keybind } from "@openloom/ui/keybind"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_OPENLOOM_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("openloom-titlebar-center"))
    setRightMount(document.getElementById("openloom-titlebar-right"))
  })
