...
beforeAll(async () => {
  ...
  mock.module("@openloom/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openloom/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openloom/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openloom/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
