    ...
    >
      ...
      >
          ...
          <div class="flex items-center gap-1 shrink-0">
            ...
            <div class="hidden xl:flex items-center shrink-0">
              ...
              >
                ...
                <div id="openloom-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
        ...
        <div class="min-w-0 flex items-center justify-center pointer-events-none">
          <div id="openloom-titlebar-center" class="pointer-events-auto min-w-0 flex justify-center w-fit max-w-full" />
        </div>
        ...
        <div
          ...
          onMouseDown={drag}
        >
          <div id="openloom-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
          <Show when={windows()}>
