import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@openloom/sdk/v2/client"
import { Button } from "@openloom/ui/button"
import { useDialog } from "@openloom/ui/context/dialog"
import { Dialog } from "@openloom/ui/dialog"
import { Icon } from "@openloom/ui/icon"
import { IconButton } from "@openloom/ui/icon-button"
import { List, type ListRef } from "@openloom/ui/list"
import { ProviderIcon } from "@openloom/ui/provider-icon"
import { Spinner } from "@openloom/ui/spinner"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "openloom"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.openloomZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.openloomZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.openloomZen.visit.prefix")}
                <Link href="https://openloom.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.openloomZen.visit.link")}
                </Link>
                {language.t("provider.connect.openloomZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
