...
import { base64Encode } from "@openloom/core/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@openloom/ui/resize-handle"
...
import { Session, type Message } from "@openloom/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@openloom/ui/toast"
...
import { retry } from "@openloom/core/util/retry"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://openloom.ai/desktop-feedback")}
      renderPanel={() =>
