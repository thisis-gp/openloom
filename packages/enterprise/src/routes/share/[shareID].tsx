import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@openloom/sdk/v2"
import { SessionTurn } from "@openloom/ui/session-turn"
import { SessionReview } from "@openloom/ui/session-review"
import { DataProvider } from "@openloom/ui/context"
import { FileComponentProvider } from "@openloom/ui/context/file"
import { WorkerPoolProvider } from "@openloom/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@openloom/ui/logo"
import { IconButton } from "@openloom/ui/icon-button"
import { ProviderIcon } from "@openloom/ui/provider-icon"
import { iife } from "@openloom/core/util/iife"
import { Binary } from "@openloom/core/util/binary"
import { NamedError } from "@openloom/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@openloom/ui/tabs"
import { MessageNav } from "@openloom/ui/message-nav"
import { FileSSR } from "@openloom/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@openloom/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/openloom-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Openloom</Title>
              </Show>
              <Meta name="description" content="openloom - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/openloom"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://openloom.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
