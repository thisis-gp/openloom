...
// test/preload.ts pins OPENLOOM_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.OPENLOOM_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.OPENLOOM_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.OPENLOOM_MODELS_PATH = undefined
  Flag.OPENLOOM_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.OPENLOOM_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.OPENLOOM_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
