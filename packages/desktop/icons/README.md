...
- Generate the PNG/ICO variants for the target channel folder under `packages/desktop/icons/{environment}`
...
The Image2Icon step is necessary because a direct `icon.icns` generated from `app-icon.png` does not apply the shadow/padding expected by macOS,
