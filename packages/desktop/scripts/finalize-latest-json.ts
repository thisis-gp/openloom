...
const releaseId = process.env.OPENLOOM_RELEASE
if (!releaseId) throw new Error("OPENLOOM_RELEASE is required")

const version = process.env.OPENLOOM_VERSION
if (!version) throw new Error("OPENLOOM_VERSION is required")
...
const macxTarGz = "openloom-desktop-mac-x64.app.tar.gz"
const macaTarGz = "openloom-desktop-mac-arm64.app.tar.gz"
