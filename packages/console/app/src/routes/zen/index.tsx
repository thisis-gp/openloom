...
import compareVideo from "../../asset/lander/openloom-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/openloom-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="openloom:auth" content={loggedin() ? "true" : "false"} />
