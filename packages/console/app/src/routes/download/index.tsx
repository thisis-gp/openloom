...
import desktopAppIcon from "../../asset/lander/openloom-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://openloom.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>openloom.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g openloom-ai")}>
                <code>
                  npm i -g <strong>openloom-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g openloom-ai")}>
                <code>
                  bun add -g <strong>openloom-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/openloom")}>
                <code>
                  brew install <strong>anomalyco/tap/openloom</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S openloom")}>
                <code>
                  paru -S <strong>openloom</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask openloom-desktop")}>
                <code>
                  brew install --cask <strong>openloom-desktop</strong>
                </code>
                <CopyStatus />
              </button>
