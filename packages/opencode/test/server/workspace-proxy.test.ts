...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips openloom-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-openloom-directory"]).toBeUndefined()
      expect(forwarded["x-openloom-workspace"]).toBeUndefined()
