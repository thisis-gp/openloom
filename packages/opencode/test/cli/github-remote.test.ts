...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openloom.git")).toEqual({ owner: "sst", repo: "openloom" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openloom")).toEqual({ owner: "sst", repo: "openloom" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openloom.git")).toEqual({ owner: "sst", repo: "openloom" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openloom")).toEqual({ owner: "sst", repo: "openloom" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openloom.git")).toEqual({ owner: "sst", repo: "openloom" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openloom")).toEqual({ owner: "sst", repo: "openloom" })
})
