...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENLOOM_CALLER", () => {
    process.env["OPENLOOM_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENLOOM_CALLER", () => {
    process.env["OPENLOOM_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENLOOM_CALLER", () => {
    process.env["OPENLOOM_CALLER"] = "unknown"
