...
const MAK_NAME_PREFIX = "openloom-oauth"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>Openloom - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to Openloom."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              ...
              instructions:
                "Sign in to DigitalOcean in your browser. Openloom will create a Model Access Key named openloom-oauth-* and load your Inference Routers. Re-run /connect to refresh routers later.",
