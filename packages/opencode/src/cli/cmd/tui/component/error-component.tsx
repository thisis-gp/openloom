...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/anomalyco/openloom/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("openloom-version", InstallationVersion)
