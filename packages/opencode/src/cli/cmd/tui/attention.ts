...
} from "@openloom/plugin/tui"
import stripAnsi from "strip-ansi"
import type { TuiConfig } from "./config/tui"
import { isAttentionSoundName } from "./config/tui-schema"
import * as TuiAudio from "@tui/util/audio"
import defaultSoundPath from "@openloom/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@openloom/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@openloom/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@openloom/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@openloom/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@openloom/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "openloom"
const DEFAULT_PACK_ID = "openloom.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "Openloom Default",
  builtin: true,
  sounds: {
