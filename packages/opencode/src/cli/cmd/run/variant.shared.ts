...
//
// The saved variant persists across sessions in ~/.local/state/openloom/model.json
...
class Service extends Context.Service<Service, VariantService>()("@openloom/RunVariant") {}
