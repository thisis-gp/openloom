...
>()("@openloom/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@openloom/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.OPENLOOM_WORKSPACE_ID ? WorkspaceID.make(Flag.OPENLOOM_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-openloom-directory"] || process.cwd()
}
