...
Practical reference for the current tool-migration state in `packages/openloom`.
...
Tool tests should use the existing Effect helpers in `packages/openloom/test/lib/effect.ts`:
