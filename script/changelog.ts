...
Generates UPCOMING_CHANGELOG.md by running the openloom changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for openloom run (default: low)
      --quiet            Suppress openloom command output unless it fails
