...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/openloom/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/openloom...\n")
...
console.log("Fetching npm all-time downloads for openloom-ai...\n")
const npmDownloads = await fetchNpmDownloads("openloom-ai")
