...
- PR #15835: https://github.com/anomalyco/openloom/pull/15835

## Do Not Translate (Locale Additions)

- `Openloom` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `openloom` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Openloom` in prose, `openloom` only for exact technical identifiers
...
- Avoid changing `openloom` to `Openloom` inside commands, URLs, package names, or code literals
