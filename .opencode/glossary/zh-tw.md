...
- PR #13942: https://github.com/anomalyco/openloom/pull/13942

## Do Not Translate (Locale Additions)

- `Openloom` (preserve casing in prose; keep `openloom` only when it is part of commands, package names, paths, or code)
- `Openloom Zen`
- `Openloom CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `openloom` in prose when referring to the product name; use `Openloom`
