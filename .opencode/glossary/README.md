...
Use this folder for locale-specific translation guidance that supplements `.openloom/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/openloom/pull/12345

## Do Not Translate (Locale Additions)

- `Openloom` (preserve casing)
